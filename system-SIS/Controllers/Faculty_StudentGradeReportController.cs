...
{
    public class Faculty_StudentGradeReportController : Controller
    {
        public IActionResult GeneratePdf()
        {
            ...
            var smallerTitleFont = new XFont("Arial", 12, XFontStyle.Regular);  // Smaller font for Masterlist of Students
