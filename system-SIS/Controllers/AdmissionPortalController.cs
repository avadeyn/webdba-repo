    ...
    public class AdmissionPortalController : Controller
    {
        ...
        public IActionResult Contact(StudentAdmission model)
        {
            if (ModelState.IsValid)
            {
                ...
                existingData.EmergencyContactPerson = model.EmergencyContactPerson;
                existingData.EmergencyContactNumber = model.EmergencyContactNumber;
                existingData.EmergencyRelationship = model.EmergencyRelationship;
        ...
        public IActionResult Family(StudentAdmission model)
        {
            if (ModelState.IsValid)
            {
                ...
                existingData.PrimaryGuardianFirstName = model.PrimaryGuardianFirstName;
                existingData.PrimaryGuardianMaidenName = model.PrimaryGuardianMaidenName;
                existingData.PrimaryGuardianLastName = model.PrimaryGuardianLastName;
                existingData.PrimaryGuardianContactNo = model.PrimaryGuardianContactNo;
                existingData.PrimaryGuardianRelationship = model.PrimaryGuardianRelationship;
